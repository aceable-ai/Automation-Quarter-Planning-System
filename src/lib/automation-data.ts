...
export const arch: Track[] = [
    ...
    s: [
      {
        ...
        i: [
          ...
          { n: "Net New Auto Publish to Craft - Feedme", s: 17, j: "MAUT-17", f: "In the works" },
      ...
      },
      {
        ...
        i: [
          ...
          { n: "Scale Voice Over/Dynamic Text + Voiceover", s: 13 },
      ...
      },
      {
        ...
        i: [
          ...
          { n: "Details from Trigger - Create All Products", s: 11.5 },
          { n: "Coupon Generation via n8n", s: 11, j: "ENGM-77" },
      ...
      },
      {
        ...
        i: [
          ...
          { n: "Streamline Regulatory Management: Scraping & Inbox", s: 7 },
      ...
      },
      {
        ...
        i: [
          ...
          { n: "Review & Sentiment Tracker - STUDENT", s: 14 },
        ],
      },
      {
    ...
    s: [
      {
        ...
        p: "Monitors search trends, competitor content gaps, audience behavior, and social platform signals. Includes topic monitoring, gap analysis, TikTok trend scraping, research insight synthesis, audience segmentation, LinkedIn outreach, and code-level SEO analysis.",
        ...
        i: [
          ...
          { n: "Audience & Segmentation Automation", s: 8 },
      ...
      },
      {
        ...
        i: [
          ...
          { n: "Automated Paid Social Content Gen", s: 15, j: "MAUT-102", f: "Will be part of DIS" },
          { n: "Sprout Social Automation", s: 15, j: "MAUT-44" },
          { n: "Discovery & Requirements - Advertising Rules", s: 14, j: "MAUT-117" },
          { n: "Email Campaign QA & Pre-Launch", s: 13.5 },
          { n: "GTM One Pager Brief", s: 0 },
          { n: "Paid Social Creative Winners Library", s: 0, j: "MAUT-107" },
          { n: "App Copy Generation", s: 0 },
        ],
      },
      {
        n: "CL: Design Intelligence System (SYS-14)", r: true, imp: "",
      ...
      },
      {
        ...
        i: [
          ...
          { n: "Channel Attribution Suspect Records", s: 15.5 },
      ...
      },
      {
        ...
        i: [
          ...
          { n: "Insurance Competitor Price Scanner", s: 14 },
          { n: "Competitor Analysis by State", s: 14, j: "MAUT-98" },
          { n: "Search Results Extraction Workflow", s: 14, j: "MAUT-119" },
          { n: "Configure Monthly Content Scheduling", s: 14, j: "MAUT-122" },
          { n: "Testing & QA - Competitor Tracking", s: 14, j: "MAUT-123" },
        ],
      },
    ],
  },
    ...
    s: [
      ...
      },
      {
        ...
        i: [
          ...
          { n: "Monthly Partner Content Audit Automation", s: 19, j: "MAUT-46" },
  ...
  {
    t: "Cross-Phase",
    d: "Projects that serve multiple tracks and lifecycle stages",
    c: "#d97706",
    s: [
      {
        ...
        i: [
          ...
          { n: "Generate QA List for Jarvis Mortgage", s: 13.5 },
    ...
    s: [
      {
        ...
        i: [
          ...
          { n: "Pull JIRA Ticket - Create Branch - Push PR", s: 20, j: "ENGM-69" },
          ...
          { n: "Rebuild Learning App in Flutter (Experimental)", s: 18, j: "ENGM-76" },
      ...
      },
      {
        ...
        i: [
          ...
          { n: "Access DOM for CRO Test Code", s: 18 },
    ...
    s: [
      {
        ...
        i: [
          { n: "Downstream DBT/PBI Environment Refreshes", s: 17 },
      ...
      },
      {
        ...
        i: [
          ...
          { n: "Get Reports from Optimizely Dashboard", s: 17 },
      ...
      },
      {
        ...
        i: [
          ...
          { n: "Snowflake DBA Role/Permissions Audit", s: 16 },
        ],
      },
      {
        ...
        i: [
          ...
          { n: "Revenue Accounting Phase 1 (GAAP Journals)", s: 16 },
          { n: "Revenue Automation Phase 2 - Stripe Fees/DIT", s: 16 },
        ],
      },
    ],
  },
    ...
    s: [
      {
        ...
        q: "TBD", cap: "TBD",
        i: [
          { n: "Autogenerate CRO/EPS/DESN Tickets from Meetings", s: 17 },
          { n: "Create Jira Tickets from CRO Ideas with Targeting", s: 17 },
          { n: "Autopopulate Slack with Meeting Notes/Actions", s: 17 },
          { n: "Standardized Ticket Comments for PBI License", s: 17 },
        ],
      },
      {
        ...
        i: [
          { n: "Build OKR & Weekly Update WF", s: 17, j: "MAUT-189" },
          { n: "Self-Serve Automation AI Agent", s: 17, f: "CONFIRM FIT" },
          { n: "Quarterly Planning Doc Consolidation", s: 17 },
          { n: "2026 Company Planning (Resourcing + Scoring)", s: 17 },
        ],
      },
      {
        ...
        i: [
          ...
          { n: "BI 101 Course Completion - Auto Reminder", s: 17.5 },
      ...
      {
        n: "CL: AceIQ Competitive Intelligence (SOPs)", imp: "High",
        p: "Operational standards and documentation for the competitive intelligence program.",
        q: "Q2 2026", cap: "Peggy (Ellen)",
        i: [
